...
const api = {
  ...
  getUser: `${GLOBAL_FRONTENT_URL_PREFIX}/User/getUser`,
  getRouterList: `${GLOBAL_FRONTENT_URL_PREFIX}/User/getRoute`,
  publickey: `${GLOBAL_FRONTENT_URL_PREFIX}/User/Publickey`
}
